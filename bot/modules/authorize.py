    ...
    if len(message_) == 2:
        ...
        if user_id in SUDO_USERS:
            ...
            with open('sudo_users.txt', 'a') as file:
                file.write(f'{user_id}\n')
                msg = 'ᴘʀᴏᴍᴏᴛᴇᴅ ᴀꜱ ꜱᴜᴅᴏ'
    elif reply_message is None:
        msg = "ɢɪᴠᴇ ɪᴅ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴍᴇꜱꜱᴀɢᴇ ᴏꜰ ᴡʜᴏᴍ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴘʀᴏᴍᴏᴛᴇ."
    else:
        # Trying to authorize someone by replying
        user_id = reply_message.from_user.id
        if user_id in SUDO_USERS:
...
def removeSudo(update, context):
    ...
    if len(message_) == 2:
        ...
        if user_id in SUDO_USERS:
            ...
            msg = 'ɴᴏᴛ ꜱᴜᴅᴏ ᴜꜱᴇʀ ᴛᴏ ᴅᴇᴍᴏᴛᴇ!'
    elif reply_message is None:
        msg = "ɢɪᴠᴇ ɪᴅ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴍᴇꜱꜱᴀɢᴇ ᴏꜰ ᴡʜᴏᴍ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ʀᴇᴍᴏᴠᴇ ꜰʀᴏᴍ ꜱᴜᴅᴏ"
    else:
        user_id = reply_message.from_user.id
        if user_id in SUDO_USERS:
            if DB_URI is not None:
...
def sendAuthChats(update, context):
    ...
    sendMessage(f'<b><u>ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴄʜᴀᴛ:</u></b>\n{user}\n<b><u>ꜱᴜᴅᴏ ᴜꜱᴇʀ:</u></b>\n{sudo}', context.bot, update.message)
